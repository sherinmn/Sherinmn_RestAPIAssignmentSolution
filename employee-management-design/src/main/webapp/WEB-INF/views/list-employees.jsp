...
<body>
	...
	<div class="container">
		...
		<form style="text-align: right">
			<br>
			<a href="/employee-management-design/employees/showFormForAdd"
				...
				<c:forEach items="${Employee}" var="tempEmployee">
					<tr>
						...
						<td style="text-align: center">
							...
							href="/employee-management-design/employees/showFormForUpdate?EmployeeId=${tempEmployee.id}"
							class="btn btn-primary btn-sm"> Update </a> <a
							href="/employee-management-design/employees/delete?EmployeeId=${tempEmployee.id}"
